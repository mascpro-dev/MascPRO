...
export default function XPBar() {
  ...
  // 1. Buscar os dados REAIS do seu perfil no Supabase
  useEffect(() => {
    ...
    // Atualizar em tempo real se o XP mudar
  ...
  if (loading) return <div className="h-32 w-full bg-slate-100 animate-pulse rounded-3xl" />
      ...
      <div className="relative z-10">
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-4">
            <div className={`h-14 w-14 rounded-2xl bg-gradient-to-br ${corPrimaria} flex items-center justify-center shadow-lg shadow-yellow-500/20`}>
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 w-full bg-white/10 rounded-full overflow-hidden border border-white/5 p-[2px]">
            <div 
              className={`h-full bg-gradient-to-r ${corPrimaria} rounded-full transition-all duration-1000 shadow-[0_0_15px_rgba(234,179,8,0.4)]`}
        ...
        <p className="text-slate-500 text-[9px] mt-4 font-bold uppercase tracking-[0.1em] text-center">
          {isEmbaixador ? "Você ganha 50% de XP em todas as atividades" : "Continue evoluindo para subir de cargo"}
        </p>
      </div>
