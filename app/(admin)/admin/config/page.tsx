...
const LABELS: Record<string, { label: string; tipo: "number" | "text"; prefixo?: string; sufixo?: string; min?: number; max?: number }> = {
  ...
  frete_fixo_valor: { label: "Frete fixo (R$ 0 = usar Correios)", tipo: "number", prefixo: "R$", min: 0 },
  frete_pac_usar_estimativa: { label: "Usar frete estimado se Correios falhar (true/false)", tipo: "text" },
