...
export default function CatalogPage() {
  ...
  const whatsappMessage =
    vendedor
      ? `Olá ${vendedor.full_name.split(" ")[0]}! Vi seu catálogo MascPRO e gostaria de saber mais sobre os produtos.`
      : "Olá! Estava vendo o catálogo MascPRO e gostaria de saber como comprar com descontos exclusivos.";
  const whatsappLink = montarWhatsApp(whatsappMessage);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              {vendedor && (
                <p className="text-[10px] text-[#C9A66B]/80 font-bold uppercase tracking-widest mt-2">
                  Atendimento: {vendedor.full_name}
                </p>
              )}
            </div>
            ...
            >
              ...
              <span className="text-[11px] font-bold text-[#C9A66B] uppercase tracking-widest group-hover:text-white transition-colors">
                {vendedor ? "Falar com o distribuidor" : "Deseja comprar com descontos?"}
              </span>
            </a>
          </div>
