...
import { Loader2, ShoppingBag, Truck, PackageCheck, Clock, CheckCircle2, XCircle } from \"lucide-react\";
...
const LABELS: Record<string, { texto: string; cor: string; icon: JSX.Element }> = {
  pending: {
      ...
      <div className=\"max-w-3xl mx-auto\">
        <div className=\"flex items-center gap-3 mb-8\">
          ...
          <div>
            ...
            <p className=\"text-xs text-zinc-500\">Acompanhe o status de cada compra na Loja MascPRO.</p>
          </div>
        </div>
        ...
        {pedidos.length === 0 ? (
          ...
          <div className=\"flex flex-col gap-4\">
            {pedidos.map((p) => {
              const info = LABELS[p.status] || LABELS.pending;
              return (
                <div
                  key={p.id}
